...
export class StructureGenerator {
    private templates: CaseTemplate[] = [
        // ── 1. THE ANTIQUE SHOP ─────────────────────────────────────────────
        {
            ...
            locations: ['shop_floor', 'back_room', 'street', 'alley'],
            mapConnections: {
                shop_floor: ['back_room', 'street'],
                back_room: ['shop_floor', 'alley'],
                street: ['shop_floor', 'alley'],
        ...
        // ── 4. THE CORPORATE TOWER ──────────────────────────────────────────
        {
            ...
            locations: ['executive_office', 'conference_room', 'elevator', 'parking_garage', 'lobby'],
            mapConnections: {
                executive_office: ['conference_room', 'elevator'],
                conference_room: ['executive_office', 'lobby'],
                elevator: ['executive_office', 'lobby', 'parking_garage'],
        ...
        // ── 5. THE ART GALLERY ──────────────────────────────────────────────
        {
            ...
            locations: ['main_gallery', 'restoration_studio', 'storage_vault', 'street', 'private_office'],
            mapConnections: {
                main_gallery: ['restoration_studio', 'street', 'private_office'],
                restoration_studio: ['main_gallery', 'storage_vault'],
                storage_vault: ['restoration_studio', 'private_office'],
                street: ['main_gallery'],
                private_office: ['main_gallery', 'storage_vault'],
            },
            weaponType: 'blunt_object',
            motiveCategory: 'envy',
            relationships: [
        ...
        // ── 6. THE LUXURY HOTEL ─────────────────────────────────────────────
        {
            ...
            locations: ['lobby', 'penthouse_suite', 'kitchen', 'service_corridor', 'rooftop'],
            mapConnections: {
                lobby: ['penthouse_suite', 'kitchen', 'service_corridor'],
                penthouse_suite: ['lobby', 'rooftop'],
                kitchen: ['lobby', 'service_corridor'],
                service_corridor: ['lobby', 'kitchen', 'rooftop'],
                rooftop: ['penthouse_suite', 'service_corridor'],
            },
            weaponType: 'poison',
            motiveCategory: 'revenge',
            relationships: [
        ...
        // ── 7. THE THEATRE ──────────────────────────────────────────────────
        {
            ...
            locations: ['main_stage', 'dressing_room', 'prop_storage', 'fly_gallery', 'stage_door'],
            mapConnections: {
                main_stage: ['dressing_room', 'prop_storage', 'fly_gallery'],
                dressing_room: ['main_stage', 'stage_door'],
                prop_storage: ['main_stage', 'fly_gallery'],
                fly_gallery: ['main_stage', 'prop_storage'],
                stage_door: ['dressing_room'],
            },
            weaponType: 'sharp_object',
            motiveCategory: 'jealousy',
            relationships: [
        ...
        // ── 8. THE PRIVATE CLINIC ────────────────────────────────────────────
        {
            ...
            locations: ['operating_theatre', 'recovery_room', 'staff_lounge', 'pharmacy', 'car_park'],
            mapConnections: {
                operating_theatre: ['recovery_room', 'staff_lounge'],
                recovery_room: ['operating_theatre', 'pharmacy'],
                staff_lounge: ['operating_theatre', 'car_park'],
                pharmacy: ['recovery_room', 'car_park'],
                car_park: ['staff_lounge', 'pharmacy'],
            },
            weaponType: 'poison',
            motiveCategory: 'revenge',
            relationships: [
        ...
        // ── 9. THE POLITICAL CAMPAIGN ────────────────────────────────────────
        {
            ...
            locations: ['campaign_hq', 'press_room', 'private_office', 'parking_structure', 'hotel_suite'],
            mapConnections: {
                campaign_hq: ['press_room', 'private_office'],
                press_room: ['campaign_hq', 'hotel_suite'],
                private_office: ['campaign_hq', 'parking_structure'],
                parking_structure: ['private_office', 'hotel_suite'],
                hotel_suite: ['press_room', 'parking_structure'],
            },
            weaponType: 'other',
            motiveCategory: 'blackmail',
            relationships: [
        ...
        // ── 10. THE RESEARCH VESSEL ─────────────────────────────────────────
        {
            ...
            locations: ['bridge', 'research_lab', 'crew_quarters', 'cargo_hold', 'deck'],
            mapConnections: {
                bridge: ['deck', 'crew_quarters'],
                research_lab: ['crew_quarters', 'cargo_hold'],
                crew_quarters: ['bridge', 'research_lab'],
                cargo_hold: ['research_lab', 'deck'],
                deck: ['bridge', 'cargo_hold'],
            },
            weaponType: 'other',
            motiveCategory: 'greed',
            relationships: [
